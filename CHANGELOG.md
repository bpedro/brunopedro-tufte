...
## [Unreleased]
### Changed
- Forked and rebranded as [bpedro/brunopedro-tufte](https://github.com/bpedro/brunopedro-tufte), based on [loikein/hugo-tufte](https://github.com/loikein/hugo-tufte).
