...
Brunopedro Tufte is a minimalist blog-like theme for the
...
- Third repo: [loikein/hugo-tufte](https://github.com/loikein/hugo-tufte)
- This ([bpedro/brunopedro-tufte](https://github.com/bpedro/brunopedro-tufte)) is a fork of loikein/hugo-tufte.
...
```shell
git clone https://github.com/bpedro/brunopedro-tufte.git
cd brunopedro-tufte/exampleSite
...
Add `theme: 'brunopedro-tufte'` to your `config.yaml` to let your site know to actually use _this_ theme, specifically.
...
For usage and examples, refer to [./exampleSite/content/post/tufte-features.md ](https://github.com/bpedro/brunopedro-tufte/blob/main/exampleSite/content/post/tufte-features.md).
